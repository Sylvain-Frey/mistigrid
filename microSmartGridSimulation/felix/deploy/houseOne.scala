...
object houseOne {
  ...
  val atmosphereModel = Atmosphere(atmosphere, 20, 12, 22)
  
  val aggregator = "houseOneAggregator"
  val aggregatorModel = Aggregator("houseOneAggregator", "houseOneAggregator", false, 
  "akka://MisTiGriD@localhost:4005/user/remotedistrictAggregator")
  
  val aggregatorController = "houseOneAggregatorController"
  val loadTopic = "houseOneLoadTopic"
