object House {
  ...
  val aggregator = Aggregator("houseAggregator", "houseAggregator", false, 
  ...
  val heaters = Map[String, Tuple2[Heater, HeaterManager]](
      heater_K	   -> (Heater(0, 0.05f, 0.1f, 400f, "houseAggregator", kitchen),	HeaterManager(heater_K   + "_manager", 50, 22, true, "loadTopic", "aggregatorController", "loadHierarch", heater_K,   kitchen)),
      heater_V     -> (Heater(0, 0.05f, 0.1f, 400f, "houseAggregator", visitors_room),	HeaterManager(heater_V   + "_manager", 50, 22, true, "loadTopic", "aggregatorController", "loadHierarch", heater_V,   visitors_room)),
      heater_C     -> (Heater(0, 0.05f, 0.1f, 400f, "houseAggregator", children_room),	HeaterManager(heater_C   + "_manager", 50, 22, true, "loadTopic", "aggregatorController", "loadHierarch", heater_C,   children_room)),
      heater_P     -> (Heater(0, 0.05f, 0.1f, 400f, "houseAggregator", parents_room),	HeaterManager(heater_P   + "_manager", 50, 22, true, "loadTopic", "aggregatorController", "loadHierarch", heater_P,   parents_room)),
      heater_LR1   -> (Heater(0, 0.05f, 0.1f, 400f, "houseAggregator", livingroom),	HeaterManager(heater_LR1 + "_manager", 50, 22, true, "loadTopic", "aggregatorController", "loadHierarch", heater_LR1, livingroom)),
      heater_LR2   -> (Heater(0, 0.05f, 0.1f, 400f, "houseAggregator", livingroom),	HeaterManager(heater_LR2 + "_manager", 50, 22, true, "loadTopic", "aggregatorController", "loadHierarch", heater_LR2, livingroom)),
      heater_B     -> (Heater(0, 0.05f, 0.1f, 400f, "houseAggregator", bathroom),	HeaterManager(heater_B   + "_manager", 50, 22, true, "loadTopic", "aggregatorController", "loadHierarch", heater_B,   bathroom)),
      heater_E     -> (Heater(0, 0.05f, 0.1f, 400f, "houseAggregator", entrance),	HeaterManager(heater_E   + "_manager", 50, 22, true, "loadTopic", "aggregatorController", "loadHierarch", heater_E,   entrance)))
